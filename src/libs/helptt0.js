...
Et.prototype.m_httpRequestSet = [],
  ...
  Et.prototype.submitRequest = function() {
    ...
    if (this.options.async) {
      var s = this.ob.c.HWP_SubmitHttpRequest(e, this.options.url, this.options.auth, this.options.data, this.options.timeout); - 1 != s && (t = {
        iRequestID: s,
        funSuccessCallback: this.options.success,
        funErrorCallback: this.options.error
      }, this.m_httpRequestSet.push(t))
    } else {
      var n = this.ob.c.HWP_SendHttpSynRequest(e, this.options.url, this.options.auth, this.options.data, this.options.timeout);
      t = {
        funSuccessCallback: this.options.success,
        funErrorCallback: this.options.error
...
Tt.prototype.CGI = {
  ...
  var r = this.obj.c.HWP_Play(n, e.szAuth, t.iWndIndex, "", "");
  if (0 == r) {
    var o = new Q(this.obj);
    o.iIndex = t.iWndIndex, o.szIP = e.szIP, o.iChannelID = t.iChannelID, o.iPlayStatus = this.obj.v, this.obj.p.push(o)
  }
  return r

...
class videoCtrl {
  ...
  GetHttpInfo = function(e, t) {
    this.Z("http响应返回：http状态：%s, http数据：%s", e, t), et.prototype.processCallback(e, t)
  }
  GetSelectWndInfo(e) {
  ...
  PluginEventHandler(e, t, s) {
    this.Z("插件事件：PluginEventHandler iEventType：%s iParam1: %s, iParam2: %s", e, t, s), this.b == e || this.M == e ? f.I_Stop(t) : L == e ? f.I_StopRecord(t) : q == e && f.I_StopVoiceTalk(), a.cbEvent && a.cbEvent(e, t, s)
  }
  ZoomInfoCallback(e) {
  ...
  I_ChangeWndNum(e) {
    return isNaN(parseInt(e, 10)) ? -1 : void this.c.HWP_ArrangeWindow(e)
  }
  I_InsertOBJECTPlugin(t) {
    var that = this;
    // var GetSelectWndInfo = that.GetSelectWndInfo.bind(this);
    // var ZoomInfoCallback = that.ZoomInfoCallback.bind(this);
    // var GetHttpInfo = that.GetHttpInfo.bind(this);
    // var PluginEventHandler = that.PluginEventHandler.bind(this);
    console.log(this.a.szContainerID, this, "I_InsertOBJECTPlugin");
    return W(t) || (this.a.szContainerID = t),
      null == document.getElementById(this.a.szContainerID) ? -1 : null != document.getElementById(this.o) || 0 != document.getElementsByName(this.o).length ? -1 : (document.getElementById(this.a.szContainerID).innerHTML = _(this), this.c = this.I.browser().msie ? document.getElementById(this.o) : document.getElementsByName(this.i)[0], null == this.c && null == this.c.object ? -1 : ("object" == typeof this.e.attachEvent && this.I.browser().msie && (
          this.c.addEventListener("GetSelectWndInfo", () => {
            console.log("GetSelectWndInfo")
          }, false),
          this.c.addEventListener("ZoomInfoCallback", ZoomInfoCallback),
          this.c.addEventListener("GetHttpInfo", () => {
            console.log("GetHttpInfo")
          }, false),
          this.c.addEventListener("PluginEventHandler", PluginEventHandler)),
        E(that), 0))
  }
  ...
  I_StartRealPlay(e, t) {
    ...
    if (I.extend(h, t), -1 != n) {
      ...
      if (C == this.R && f.oStreamCapa.bSupportShttpPlay ? (this.Z("SHTTP RealPlay"), o = f.oProtocolInc.CGI.startShttpRealPlay, i = "http://", d = h.iStreamType - 1, c = h.iChannelID <= f.iAnalogChannelNum ? h.iChannelID : f.oStreamCapa.iIpChanBase + parseInt(h.iChannelID, 10) - f.iAnalogChannelNum - 1, P = !0, W(h.iPort) ? "https://" == f.szHttpProtocol ? (-1 == f.iHttpPort && (f.iHttpPort = B(f).iHttpPort), a = f.iHttpPort) : a = f.iCGIPort : (f.iHttpPort = h.iPort, a = h.iPort)) : (this.Z("RTSP RealPlay"), o = f.oProtocolInc.CGI.startRealPlay, i = "rtsp://", d = h.iStreamType, c = h.iChannelID, W(h.iPort) || (f.iRtspPort = h.iPort), -1 == f.iRtspPort && (f.iRtspPort = B(f).iRtspPort), a = f.iRtspPort), -1 == a) return this.Z("获取端口号失败"), r;
      if (I.extend(h, {
          urlProtocol: i,
          cgi: o,
          iPort: a,
  ...
  I_Login(e, t, s, n, r, o) {
    ...
    if (-1 != i) return this.Z("设备已经登录过"), -1;
    var a = this.P,
      c = this.C;
...
var s = window,
  ...
  _ = function(obj) {
    var e = "";
    if (obj.I.browser().msie) e = "<object classid='" + obj.a.szOcxClassId + "' codebase='' standby='Waiting...' id='" + obj.o + "' width='" + obj.n + "' height='" + obj.r + "' align='center' ><param name='wndtype' value='" + obj.a.iWndowType + "'><param name='playmode' value='" + obj.a.iPlayMode + "'><param name='colors' value='" + obj.a.szColorProperty + "'></object>";
    else
      for (var t = navigator.mimeTypes.length, s = 0; t > s; s++) navigator.mimeTypes[s].type.toLowerCase() == obj.a.szMimeTypes && (e = "<embed align='center'  wmode='Opaque' windowlessVideo='true' type='" + obj.a.szMimeTypes + "' width='" + obj.n + "' height='" + obj.r + "' name='" + obj.i + "' wndtype='" + obj.a.iWndowType + "' playmode='" + obj.a.iPlayMode + "' colors='" + obj.a.szColorProperty + "'>");
    return e
  },
  E = function(obj) {
    var e = obj.c.HWP_GetLocalConfig();
    obj.m = obj.I.loadXML(e)
  },
  N = function(e, obj) {
    obj.I_GetDeviceInfo(e.szIP, {
      success: function(t) {
        e.szDeviceType = window.$XML(t).find("deviceType").eq(0).text()
      }
    }), obj.I_GetAnalogChannelInfo(e.szIP, {
      success: function(t) {
        e.iAnalogChannelNum = window.$XML(t).find("VideoInputChannel", !0).length
      }
    }), obj.I_GetAudioInfo(e.szIP, {
      success: function(t) {
  ...
  U = function(e) {
    ...
    return e.oProtocolInc.getUPnPPortStatus(e, {
      async: !1,
      success: function(e) {
        for (var o = window.$XML(e).find("portStatus", !0), i = 0, a = o.length; a > i; i++) "rtsp" == window.$XML(o).eq(i).find("internalPort").eq(0).text().toLowerCase() && (t = parseInt(window.$XML(o).eq(i).find("externalPort").eq(0).text(), 10)), "http" == window.$XML(o).eq(i).find("internalPort").eq(0).text().toLowerCase() && (n = parseInt(window.$XML(o).eq(i).find("externalPort").eq(0).text(), 10)), "admin" == window.$XML(o).eq(i).find("internalPort").eq(0).text().toLowerCase() && (r = parseInt(window.$XML(o).eq(i).find("externalPort").eq(0).text(), 10))
      },
      error: function() {
        t = -1, n = -1, r = -1
      }
  ...
  j = function(e, obj) {
    e.oStreamCapa.bObtained || e.oProtocolInc instanceof Tt && (obj.G == e.szDeviceType || obj.X == e.szDeviceType || obj.H == e.szDeviceType ? e.oProtocolInc.getStreamChannels(e, {
      async: !1,
      success: function(t) {
...
window.PluginEventHandler = function(e, t, s) {
  videoCtrl1.Z("插件事件：PluginEventHandler iEventType：%s iParam1: %s, iParam2: %s", e, t, s), videoCtrl1.b == e || videoCtrl1.M == e ? videoCtrl1.I_Stop(t) : L == e ? videoCtrl1.I_StopRecord(t) : q == e && videoCtrl1.I_StopVoiceTalk(), videoCtrl1.a.cbEvent && videoCtrl1.a.cbEvent(e, t, s)
};
window.GetHttpInfo = function(e, t) {
  videoCtrl1.Z("http响应返回：http状态：%s, http数据：%s", e, t), Et.prototype.processCallback(e, t)
};

<template>
     <div id="pointsTable" style="width:100%;height:100%;" class=" big_table backImage">
       <p>
  ...
  //
  // }
#pointsTable  .big_table_cell{
    color:#5bf4fd;
    padding:10px 10px 10px 10px;
    font-size: 12px;
    text-align: center;
  }
#pointsTable   .big_table{
  ...
  #pointsTable  .my-scroll-bar{
      height:200px;
  }
#pointsTable   .clear{ clear:both}


  /* override gemini-scrollbar default styles */

/* vertical scrollbar track */
#pointsTable .gm-scrollbar.-vertical {
  background-color: red
}

/* horizontal scrollbar track */
#pointsTable  .gm-scrollbar.-horizontal {
  background-color: transparent;
}

/* scrollbar thumb */
#pointsTable .gm-scrollbar .thumb {
  background-color: rebeccapurple;
}
#pointsTable .gm-scrollbar .thumb:hover {
...
#pointsTable  .scrollbar::-webkit-scrollbar {/*滚动条整体样式*/
        width: 5px;     /*高宽分别对应横竖滚动条的尺寸*/
        height: 10px;
    }
 #pointsTable  .scrollbar::-webkit-scrollbar-thumb {/*滚动条里面小方块*/
        border-radius: 10px;
         -webkit-box-shadow: inset 0 0 5px rgba(0,0,0,0.2);
        background: #535353;
    }
 #pointsTable .scrollbar::-webkit-scrollbar-track {/*滚动条里面轨道*/
        -webkit-box-shadow: inset 0 0 5px rgba(0,0,0,0.2);
        border-radius: 10px;
        background: #EDEDED;
    }

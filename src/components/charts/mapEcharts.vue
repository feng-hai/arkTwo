...
<script>
import jsanData from './jiangsuAnhui.json'
...
export default {
  props: {
    ...
    height: {
      type: String,
      default: document.documentElement.clientHeight - 120 + 'px'
    }
  },
  data() {
    return {
      ...
      this.option.geo = { //引入地图 ，渲染地图凹凸显示
        ...
        this.option.series = [{
            ...
            data: [
              ...
              {
                name: '南京站',
                value: [118.79993859790038, 32.085268595927914]
              },
              {
                name: '南京南站',
                value: [118.798172, 31.968729]
              },
              {
                name: '合肥南站',
                value: [117.290359, 31.798882]
              },
              {
                name: '徐州东站',
                value: [117.18554, 34.28823]
              }
            ]
          }
